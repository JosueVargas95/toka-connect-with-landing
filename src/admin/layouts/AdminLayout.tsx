          ...
          <div className="flex h-full flex-col border-r">
            <div className="flex items-center justify-between p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-semibold">Toka Connect</h2>
                ...
                <button className="flex w-full items-center justify-between rounded-2xl px-3 py-2 text-sm font-medium hover:bg-muted">
                  <div className="flex items-center gap-3">
                    <Avatar className="h-6 w-6">
                      <AvatarImage src="../../public/avatar.png" alt="User" />
                      <AvatarFallback>JV</AvatarFallback>
                    </Avatar>
                    <span>Josué Vargas</span>
                  </div>
                        ...
                        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                          <div className="space-y-4">
                            ...
                            <h2 className="text-3xl font-bold">
                              Welcome to Toka Connect
                            </h2>
                            <p className="max-w-[600px] text-white/80">
                              Unleash your creativity with our comprehensive
                              suite of professional design tools and resources.
                            </p>
                      ...
                      >
                        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                          <div className="space-y-2">
                            ...
                            <p className="max-w-[600px] text-white/80">
                              Expand your creative skills with tutorials,
